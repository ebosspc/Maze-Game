...
def move_forward(current_maze_navigator_color_index):
    ...
    #Grab x and y position of maze navigator
    #global x,y,margin,near_items,canvas_color
    x,y = maze_navigator.position()
    #Find close items within a reasonable margin
    margin = 7
